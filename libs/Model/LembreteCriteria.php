...
require_once("DAO/LembreteCriteriaDAO.php");

/**
 * The LembreteCriteria class extends LembreteDAOCriteria and is used
 ...
 * @version 1.0
 */
class LembreteCriteria extends LembreteCriteriaDAO
{
