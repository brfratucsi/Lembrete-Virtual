...
GlobalConfig::$CONNECTION_SETTING->DBName = "desenvolvimento_servidores_2_final";
...
/** the root url of the application with trailing slash, for example http://localhost/desenvolvimentoservidores2final/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'desenvolvimentoservidores2final/';
