...
<html lang="en">
	<head>
		...
		<meta name="description" content="DESENVOLVIMENTOSERVIDORES2FINAL" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">DESENVOLVIMENTOSERVIDORES2FINAL</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								<li <?php if ($this->nav=='lembretes') { echo 'class="active"'; } ?>><a href="./lembretes">Lembretes</a></li>
								</ul>
								</li>
							</ul>
