/**
 * backbone model definitions for DESENVOLVIMENTOSERVIDORES2FINAL
 */
...
/**
 * Lembrete Backbone Model
 */
model.LembreteModel = Backbone.Model.extend({
	urlRoot: 'api/lembrete',
	idAttribute: 'registro',
	registro: '',
	titulo: '',
	prioridade: '',
	descricao: '',
...
/**
 * Lembrete Backbone Collection
 */
model.LembreteCollection = model.AbstractCollection.extend({
	url: 'api/lembretes',
	model: model.LembreteModel
});
